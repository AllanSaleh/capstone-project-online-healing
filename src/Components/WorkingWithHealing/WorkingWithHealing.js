        ...
        <div className="pt-navbar px-sides font-body pb-24">
            ...
            <div className="flex flex-col">
                ...
                <div className="text-jusfify space-y-6 w-3/4 mt-8">
                    ...
                    <p  className="text-paragraph text-justify text-gray-700">Over 10,000 people sign up on BetterHelp every day looking for a counselor to help with life’s challenges. BetterHelp can be your main source of income ("full time") or a supplement to your current work.</p>
                </div>
                <div className="text-jusfify space-y-6 w-3/4 mt-8">
                    <p className="text-subtitle ">Focus on Counseling</p>
                    <p  className="text-paragraph text-justify text-gray-700">No need to worry about costs from acquiring clients, billing, support or operations. Let us handle the fees and paperwork so you can focus on what you do best!</p>
                </div>
