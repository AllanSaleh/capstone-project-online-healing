    ...
    <div className="pt-navbar px-sides  pb-24">
      <div className="flex flex-col lg:flex-row">
        <div className="flex flex-col">
          ...
          <div className="text-jusfify space-y-6 w-3/4 mt-8">
            ...
            <p className="lg:text-paragraph text-justify text-gray-700">
              ...
              main source of income ("full time") or a supplement to your
              current work.
            </p>
          </div>
          <div className="text-jusfify space-y-6 w-3/4 mt-8">
        ...
        <img
          src={Frame}
          alt="illustration"
          className="object-scale-down lg:h-60 w-full lg:mt-60"
        />
      </div>
      <div className="space-y-6 mt-8">
        ...
        <button className="self-center lg:w-1/6 h-12 text-lg lg:text-subtitle bg-blue-dark rounded-lg border-2 border-transparent hover:bg-white hover:text-blue-dark hover:border-blue-dark px-100 uppercase">
          Get Started
        </button>
      </div>
    </div>
