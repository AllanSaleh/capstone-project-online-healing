  ...
  return (
    <div className="h-1/2 px-sides pt-navbar">
      ...
      <div className="text-paragraph">
        ...
        the least understood and least transparent aspects of great marketing, and we see that as an
        opportunity. We're excited to simplify SEO for everyone through our software, education, and
        community.
      </div>
    </div>
  );
