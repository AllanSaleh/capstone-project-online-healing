                 ...
                 LOGIN
                    ...
                    <div className=" lg:w-96 lg:h-72 h-72 bg-white shadow-xl rounded-lg ">
                        <div className="flex flex-col">
                            ...
                            <button className="mt-6 lg:mt-6 lg:mx-0 mx-5 lg:py-4 lg:px-10  py-2 px-6 lg:text-subtitle text-base rounded-md bg-blue-dark border hover:bg-white hover:text-blue-dark hover:border-blue-dark">LOG IN</button>
                            <button className="mt-4 lg:mt-6 lg:mx-0 mx-5 lg:py-4 lg:px-10  py-2 px-6 lg:text-subtitle text-base rounded-md text-blue-dark bg-white border hover:bg-blue-dark hover:text-black hover:border-blue-dark">SIGN UP</button>
                            </div>
                        </div>
                    </div>
                    <div className="mt-10 ">
