...
const TicketSection = () => (
  <div className="h-section flex flex-col px-sides">
    ...
    <div className="flex flex-col justify-center items-center mt-32">
      ...
      <button className="text-subtitle uppercase mt-8 bg-blue-dark rounded-lg py-2 px-4 border hover:bg-transparent hover:border-blue-dark hover:text-blue-dark transition-all duration-300">
        learn more
      </button>
    </div>
  </div>
