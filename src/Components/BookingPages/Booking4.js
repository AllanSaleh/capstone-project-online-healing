  ...
  return (
    <div className="h-firstsection px-sides pt-navbar">
      ...
      <div className="flex flex-col justify-evenly h-2/3 max-w-3xl my-16 mx-auto px-8 py-4 shadow-md">
        <div>Are there any specific quality that you would prefer in a counselor?</div>
        ...
        <button
          type="button"
          className="uppercase bg-blue-dark px-6 py-3 text-subtitle rounded-md border hover:bg-transparent hover:border-blue-dark hover:text-blue-dark transition duration-300"
        >
          next
        </button>
      </div>
