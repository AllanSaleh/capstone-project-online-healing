...
const ProfileInputField = ({ title, id, type, icon, placeholder }) => (
  <div className="flex items-center my-6">
    ...
    <div className="w-2/3 inline-flex items-center border border-black border-opacity-20 rounded-lg pl-4">
      <input type={type} id={id} name={id} className="w-11/12 h-full outline-none py-3" placeholder={placeholder} />
      {icon && (
        <button>
