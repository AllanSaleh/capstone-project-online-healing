...
function Description() {
    return (
        <div className="text-left bg-yellow-primary h-section w-full px-sides m-" >
           ...
           <div>
               <button className=" pt-4 pb-4 pl-12 pr-12 text-subtitle rounded-md bg-blue-dark border-transparent hover:bg-white hover:text-blue-dark hover:border-blue-dark">LEARN MORE</button>
           </div>
        </div>
    )
}
